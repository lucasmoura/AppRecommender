...
def train_machine_learning():
    ...
    os.system("python {0}/pkg_time_list.py".format(folder_path))

    print("\n - Generating debtags")
    os.system("python {0}/get_axipkgs.py -t XT > {1}tags.txt".format(folder_path,
                                                              USER_DATA_DIR))

    print("\n - Making machine learning traning")
    os.system("rm -f {0}/pkgs_classifications.txt".format(USER_DATA_DIR))
    os.system("python {0}/pkg_classification.py".format(folder_path))
    ...
    os.system("python {0}/generate_bag_of_words.py".format(folder_path))
